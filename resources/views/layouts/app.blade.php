...
<body class="ls-closed @if(Auth::user()->role_id == 1) theme-indigo @else theme-teal @endif">
    <!-- Page Loader -->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('/')}}"><img src="{{ asset('images/logo.svg')}}" alt="profile img" style="width: 20px; display: inline;"> Focus Rentcar - @if(Auth::user()->role_id == 1) Administrador @else Empleado @endif</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            <!-- User Info -->
            <div class="user-info" style="background: url({{ asset('images/user-img-background.jpg') }}) no-repeat; background-size: auto;">
                <div class="image">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="{{route('empleado-tipo-vehiculo')}}">
