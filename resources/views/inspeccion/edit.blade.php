                ...
                <!--ul class="header-dropdown m-r--5">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="{{route('index-renta')}}">Listado de clientes</a></li>
                        </ul>
                    </li>
                </ul-->
            </div>
            <div class="body">
                <form action="/inspeccion/{{$inspeccion->slug}}" method="POST">
                @csrf
                @method('PUT')
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="date" class="form-control" value="{{ $inspeccion->fecha_inspeccion->format('Y-m-d') }}" name="fecha_inspeccion">
                            </div>
                            ...
                            <div class="form-line">
                                <select class="form-control show-tick" name="empleado">
                                    ...
                                    @foreach ($empleados as $empleado)
                                        <option value="{{$empleado->id}}" @if($inspeccion->empleado_id == $empleado->id) selected @elseif($empleado->id == Auth::user()->id) selected @endif>{{$empleado->full_name}} ( {{$empleado->email}} )</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('empleado')
                ...
                <div class="row clearfix">
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="demo-radio-button">
                                <input name="ralladura" @if($inspeccion->ralladura == 'Si') checked @endif value="Si" type="radio" class="with-gap" id="radio_1" />
                                <label for="radio_1">Si</label>
                                <input name="ralladura" @if($inspeccion->ralladura == 'No') checked @endif value="No" type="radio" id="radio_2"  class="with-gap" />
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="demo-radio-button">
                                <input name="goma_repuesto" @if($inspeccion->goma_repuesto == 'Si') checked @endif value="Si" type="radio" class="with-gap" id="radio_3" />
                                <label for="radio_3">Si</label>
                                <input name="goma_repuesto" @if($inspeccion->goma_repuesto == 'No') checked @endif value="No" type="radio" id="radio_4"  class="with-gap" />
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="demo-radio-button">
                                <input name="gato" @if($inspeccion->gato == 'Si') checked @endif value="Si" type="radio" class="with-gap" id="radio_5" />
                                <label for="radio_5">Si</label>
                                <input name="gato" @if($inspeccion->gato == 'No') checked @endif value="No" type="radio" id="radio_6"  class="with-gap" />
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="demo-radio-button">
                                <input name="rotura_cristal" @if($inspeccion->rotura_cristal == 'Si') checked @endif value="Si" type="radio" class="with-gap" id="radio_7" />
                                <label for="radio_7">Si</label>
                                <input name="rotura_cristal" @if($inspeccion->rotura_cristal == 'No') checked @endif value="No" type="radio" id="radio_8"  class="with-gap" />
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group"><br>
                                <div class="demo-checkbox">
                                    <div class="col-md-3">
                                        <input type="checkbox" id="md_checkbox_1" name="gomas[]" @if(is_array($gomas) && in_array('Goma-superior-izquierda',$gomas)) checked @endif value="Goma-superior-izquierda" class="filled-in chk-col-red"/>
                                        <label for="md_checkbox_1">Goma superior izquierda</label>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" id="md_checkbox_2" name="gomas[]" @if(is_array($gomas) && in_array('Goma-superior-derecha',$gomas)) checked @endif value="Goma-superior-derecha" class="filled-in chk-col-red"/>
                                        <label for="md_checkbox_2">Goma superior derecha</label>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" id="md_checkbox_3" name="gomas[]" @if(is_array($gomas) && in_array('Goma-inferior-izquierda',$gomas)) checked @endif value="Goma-inferior-izquierda" class="filled-in chk-col-red"/>
                                        <label for="md_checkbox_3">Goma inferior izquierda</label>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" id="md_checkbox_4" name="gomas[]" @if(is_array($gomas) && in_array('Goma-inferior-derecha',$gomas)) checked @endif value="Goma-inferior-derecha" class="filled-in chk-col-red"/>
