                            ...
                            <div class="form-line">
                                <select class="form-control show-tick" name="tipo_vehiculo">
                                    ...
                                    @foreach ($tipo_vehiculos as $tipo_vehiculo)
                                        <option value="{{$tipo_vehiculo->id}}" @if(old('tipo_vehiculo') == $tipo_vehiculo->id) selected @endif>{{$tipo_vehiculo->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('tipo_vehiculo')
                ...
                <div class="row clearfix">
                            ...
                            <div class="form-line">
                                <select class="form-control show-tick" name="marca" id="marca">
                                    ...
                                    @foreach ($marcas as $marca)
                                        <option value="{{$marca->id}}" @if(old('marca') == $marca->id) selected @endif>{{$marca->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('marca')
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="number" class="form-control key" name="anio" id="anio" value="{{ old('anio') }}" placeholder="Ex: XXXX">
                            </div>
                            @error('anio')
                                <span class="invalid-feedback" style="color:#dc3545; font-size:12px;" role="alert">
                                    <strong>{{ $message }}</strong>
                ...
                <div class="row clearfix">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control key" name="chasis" value="{{ old('chasis') }}" placeholder="Ex: XXX0X0X0XX0X00XXX">
                            </div>
                            @error('chasis')
                                <span class="invalid-feedback" style="color:#dc3545; font-size:12px;" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control key" name="motor" value="{{ old('motor') }}" placeholder="Ex: XXX0-XXXX-XX00-X">
                            </div>
                            @error('motor')
                                <span class="invalid-feedback" style="color:#dc3545; font-size:12px;" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control key" name="placa" value="{{ old('placa') }}" placeholder="Ex: XXX0-XXXX-XX00">
                            </div>
                            @error('placa')
                                <span class="invalid-feedback" style="color:#dc3545; font-size:12px;" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            <div class="form-line">
                                <select class="form-control show-tick" name="combustible">
                                    ...
                                    @foreach ($combustibles as $combustible)
                                        <option value="{{$combustible->id}}" @if(old('combustible') == $combustible->id) selected @endif>{{$combustible->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('combustible')
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control key" name="descripcion" value="{{ old('descripcion') }}" placeholder="Ex: XXX0-XXXX-XX00-X">
                            </div>
                            @error('descripcion')
                                <span class="invalid-feedback" style="color:#dc3545; font-size:12px;" role="alert">
                                    <strong>{{ $message }}</strong>
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        <div class="form-group">
                            <button type="submit" onclick="setModelo($('#modelo').children('option:selected').val())" class="btn btn-block btn-lg btn-success waves-effect">AGREGAR VEHICULO</button>
                        </div>
                    </div>
                </div>
            </form>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        getModelos($('#marca').children("option:selected").val());
    });
    ...
    //Para que se marque el old del select de modelos
    function setModelo(modelo){
        sessionStorage.setItem('modelo_id',modelo);
    }

    function getModelos(thisModelo) {
        $.ajax({
            ...
            success: function(modelos) {
                ...
                if (thisModelo == "") {
                    ...
                    modelos.forEach(modelo => {
                        if (sessionStorage.getItem('modelo_id') == modelo.id) {
