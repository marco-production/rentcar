                            ...
                            <div class="form-line">
                                <select class="form-control show-tick" name="vehiculo">
                                    ...
                                    @foreach ($vehiculos as $vehiculo)
                                        <option value="{{$vehiculo->id}}" @if(old('vehiculo') == $vehiculo->id) selected @endif>{{$vehiculo->marca_name}} {{$vehiculo->modelo_name}} {{$vehiculo->anio}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('vehiculo')
                            ...
                            <div class="form-line">
                                <select class="form-control show-tick" name="cliente">
                                    ...
                                    @foreach ($clientes as $cliente)
                                        <option value="{{$cliente->id}}" @if(old('cliente') == $cliente->id) selected @endif>{{$cliente->full_name}} - {{$cliente->cedula}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('cliente')
                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="date" class="form-control"  value="{{ old('fecha_renta') }}" name="fecha_renta">
                            </div>
                            @error('fecha_renta')
                                <span class="invalid-feedback" style="color:#dc3545; font-size:12px;" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="date" class="form-control"  value="{{ old('fecha_devolucion') }}" name="fecha_devolucion">
                            </div>
                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="number" class="form-control" id="monto" value="{{ old('monto') }}" name="monto" placeholder="RD$ 00000">
                            </div>
                            @error('monto')
                                <span class="invalid-feedback" style="color:#dc3545; font-size:12px;" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="number" class="form-control" id="dia" value="{{ old('dias') }}" name="dias" placeholder="00">
                            </div>
                            @error('dias')
                                <span class="invalid-feedback" style="color:#dc3545; font-size:12px;" role="alert">
                                    <strong>{{ $message }}</strong>
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control key" name="comentario" value="{{ old('comentario') }}" placeholder="Escribe algun comentario sobre la renta">
                            </div>
                            @error('comentario')
                                <span class="invalid-feedback" style="color:#dc3545; font-size:12px;" role="alert">
                                    <strong>{{ $message }}</strong>
